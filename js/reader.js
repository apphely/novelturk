            ...
            card.innerHTML =
                ...
                '<div class="nt-card-body" style="padding:24px 24px 32px;">' +
                    '<div class="reader-text-wrap" style="padding:20px 0;">' +
                        ...
                        '</div>' +
                    '</div>' +
                    '<div class="chapter-ornament"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 24"><line x1="0" y1="12" x2="190" y2="12" stroke="currentColor" stroke-width="0.5" opacity="0.28"/><path d="M190,12 Q202,4 214,12 Q226,20 238,12 Q250,4 262,12" fill="none" stroke="currentColor" stroke-width="0.85" opacity="0.4"/><line x1="262" y1="12" x2="280" y2="12" stroke="currentColor" stroke-width="0.5" opacity="0.3"/><circle cx="300" cy="12" r="5" fill="none" stroke="currentColor" stroke-width="0.9" opacity="0.5"/><circle cx="300" cy="12" r="2" fill="currentColor" opacity="0.5"/><line x1="320" y1="12" x2="338" y2="12" stroke="currentColor" stroke-width="0.5" opacity="0.3"/><path d="M338,12 Q350,4 362,12 Q374,20 386,12 Q398,4 410,12" fill="none" stroke="currentColor" stroke-width="0.85" opacity="0.4"/><line x1="410" y1="12" x2="600" y2="12" stroke="currentColor" stroke-width="0.5" opacity="0.28"/></svg></div>' +
                '</div>';

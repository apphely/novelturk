    ...
    <aside class="nt-sidebar">
        ...
        <div class="nt-card" style="background-color: var(--bg-surface); border:none; overflow:visible; margin-bottom:24px;">
            <div class="nt-card-body" style="overflow:visible;">
                ...
                <div class="nt-card" style="background-color: var(--bg-surface); border:none; margin-bottom:24px; margin-top:24px;">
                    <div class="nt-card-body">
                        ...
                        <a class="dost-site-link" target="_blank" href="https://lnmakineceviri.blogspot.com/">
                            <button class='text-white rounded-full px-5 py-2.5 text-center flex items-center grow' style="background: none; border: none; cursor: pointer; width: 100%; display: flex; align-items: center;">
                                ...
                                <span class="dost-site-metin">
                                    <p class="dost-site-yazi" style="color:#fff; font-weight:700; margin:0; padding-left:12px;">LN Makine Çeviri</p>
                                    <p class="dost-site-yazi" style="color:#fff; font-size:12px; margin:0; padding-left:12px; opacity:0.95;">Türkçe Novel Makine Çeviri</p>
                                </span>
                            </button>
                        </a>
                        ...
                        <a class="dost-site-link" target="_blank" href="https://turkcenoveloku.blogspot.com/">
                            <button class='text-white rounded-full px-5 py-2.5 text-center flex items-center grow' style="background: none; border: none; cursor: pointer; width: 100%; display: flex; align-items: center;">
                                ...
                                <span class="dost-site-metin">
                                    <p class="dost-site-yazi" style="color:#fff; font-weight:700; margin:0; padding-left:12px;">Türkçe Novel Oku</p>
                                    <p class="dost-site-yazi" style="color:#fff; font-size:12px; margin:0; padding-left:12px; opacity:0.95;">Türkçe Novel Yapay Zeka Çeviri</p>
                                </span>
                            </button>
                        </a>
                        ...
                        <a class="dost-site-link" target="_blank" href="https://culturesubs.com/">
                            <button class='text-white rounded-full px-5 py-2.5 text-center flex items-center grow' style="background: none; border: none; cursor: pointer; width: 100%; display: flex; align-items: center;">
                                ...
                                <span class="dost-site-metin">
                                    <p class="dost-site-yazi" style="color:#fff; font-weight:700; margin:0; padding-left:12px;">Culture Subs</p>
                                    <p class="dost-site-yazi" style="color:#fff; font-size:12px; margin:0; padding-left:12px; opacity:0.95;">Türkçe Manga ve Anime</p>
                                </span>
                            </button>
                        </a>
                    </div>

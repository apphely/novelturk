    ...
    <main class="nt-main">
        ...
        <div style="position: relative; border-radius: 16px; overflow: hidden; margin-bottom: 2rem; min-height: 220px; display: flex; align-items: center; background: linear-gradient(135deg, #1e3a5f 0%, #0f172a 50%, #1a1a2e 100%); border: 1px solid rgba(255,255,255,0.1);">
            ...
            <svg style="position: absolute; inset: 0; width: 100%; height: 100%; z-index: 2;" preserveAspectRatio="none" viewBox="0 0 400 400">
                <defs>
                    <filter id="grid-glow">
                        <feDropShadow dx="0" dy="0" stdDeviation="2" flood-opacity="0.6" flood-color="rgba(255,255,255,0.8)"/>
                    </filter>
                    <pattern id="diagonal-grid" x="0" y="0" width="30" height="30" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
                        <line x1="0" y1="0" x2="0" y2="30" stroke="rgba(0,0,0,0.7)" stroke-width="30" filter="url(#grid-glow)"/>
                    </pattern>
                </defs>

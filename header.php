        ...
        <div class="header-actions">
            ...
            <div class="header-dropdown-wrap">
                ...
                <div class="header-dropdown" id="kitaplik-dropdown">
                    <div class="dropdown-header">Kitaplık</div>
                    <div id="kitaplik-list" class="dropdown-list">
                        <p class="empty-msg">Henüz takip yok.</p>
                    </div>
                    <a href="<?php echo home_url('/bookmark'); ?>" class="dropdown-footer-link">Gelişmiş Kitaplık</a>
                </div>
            </div>
            ...
            <div class="header-dropdown-wrap">
                ...
                <div class="header-dropdown" id="header-dropdown">
                    ...
                    <a href="<?php echo home_url('/novel-evrenleri/'); ?>">
                        <svg height="18" viewBox="0 0 24 24" width="18" fill="currentColor"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M7.027 11.477a5 5 0 1 0 5.496-4.45a4.95 4.95 0 0 0-3.088.681"/><path d="M5.636 5.636a9 9 0 1 0 3.555-2.188"/><path d="M17 5a1 1 0 1 0 2 0a1 1 0 1 0-2 0m-6 7a1 1 0 1 0 2 0a1 1 0 1 0-2 0m-3 4a1 1 0 1 0 2 0a1 1 0 1 0-2 0" fill="currentColor"/></g></svg>
                        Novel Evrenleri
                    </a>
                    <a href="<?php echo home_url('/turk-novelleri-ve-romanlari/'); ?>">
                        <svg height="18" viewBox="0 0 64 64" width="18" fill="currentColor"><path d="M32 2C15.432 2 2 15.432 2 32s13.432 30 30 30s30-13.432 30-30S48.568 2 32 2m-3.117 15.25c4.381 0 8.311 1.955 10.984 5.049a11.53 11.53 0 0 0-6.638-2.099c-6.444 0-11.668 5.283-11.668 11.8s5.224 11.8 11.668 11.8c2.466 0 4.753-.775 6.638-2.097c-2.674 3.092-6.604 5.047-10.984 5.047C20.828 46.75 14.3 40.147 14.3 32s6.528-14.75 14.583-14.75M49.7 36.254l-5.263-1.638l-3.246 4.268l.012-5.267L35.934 32l5.27-1.617l-.012-5.266l3.246 4.267l5.263-1.638L46.436 32z"/></svg>
                        Türk Novelleri ve Romanları
                    </a>
                    <hr class="dropdown-divider">
                    ...
                    <a href="<?php echo home_url('/iletisim/'); ?>">
                        <svg height="18" viewBox="0 0 24 24" width="18" fill="currentColor"><path d="M16.457 2.883a31.332 31.332 0 0 0-8.913 0a3.197 3.197 0 0 0-2.73 2.874l-.126 1.396a53.504 53.504 0 0 0 0 9.694l.127 1.396a3.197 3.197 0 0 0 2.729 2.874c2.955.425 5.957.425 8.912 0a3.197 3.197 0 0 0 2.73-2.874l.126-1.396c.293-3.225.293-6.47 0-9.694l-.127-1.396a3.196 3.196 0 0 0-2.729-2.874M10 9a2 2 0 1 1 4 0a2 2 0 0 1-4 0m-2 6.5a3 3 0 0 1 3-3h2a3 3 0 0 1 3 3a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1" fill-rule="evenodd" clip-rule="evenodd"/></svg>
                        İletişim
                    </a>
                    <hr class="dropdown-divider">
                    <button type="button" class="nsfw-toggle" id="nsfw-toggle-btn">
                        <svg height="18" viewBox="0 0 24 24" width="18" fill="currentColor"><path d="M18 5h1v1a1 1 0 0 0 2 0V5h1a1 1 0 0 0 0-2h-1V2a1 1 0 0 0-2 0v1h-1a1 1 0 0 0 0 2M7 7v10a1 1 0 0 0 2 0V7a1 1 0 0 0-2 0m14.6 2a1 1 0 0 0-.78 1.18a9 9 0 1 1-7-7a1 1 0 1 0 .4-2A10.8 10.8 0 0 0 12 1a11 11 0 1 0 11 11a10.8 10.8 0 0 0-.22-2.2A1 1 0 0 0 21.6 9M11 9v1a3 3 0 0 0 .78 2a3 3 0 0 0-.78 2v1a3 3 0 0 0 3 3h1a3 3 0 0 0 3-3v-1a3 3 0 0 0-.78-2a3 3 0 0 0 .78-2V9a3 3 0 0 0-3-3h-1a3 3 0 0 0-3 3m5 6a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1v-1a1 1 0 0 1 1-1h1a1 1 0 0 1 1 1Zm0-6v1a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1h1a1 1 0 0 1 1 1"/></svg>
                        NSFW
                        <span class="nsfw-badge nsfw-badge-off">Kapalı</span>
                        <span class="nsfw-badge nsfw-badge-on" style="display:none;">Açık</span>
                    </button>
                </div>
            </div>
        </div>
